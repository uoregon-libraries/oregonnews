...
urlpatterns += patterns(
   ...
   url(r'^history/bentondemocrat/$','bentondemocrat', name="chronam_bentondemocrat"),
    url(r'^history/corvallisdailygazettetimes/$','corvallisdailygazettetimes', name="chronam_corvallisdailygazettetimes"),
    url(r'^history/corvallisgazette/$','corvallisgazette', name="chronam_corvallisgazette"),
    url(r'^history/corvallistimes/$','corvallistimes', name="chronam_corvallistimes"),
    url(r'^history/crookcountyjournal/$','crookcountyjournal', name="chronam_crookcountyjournal"),
    url(r'^history/douglasindependent/$','douglasindependent', name="chronam_douglasindependent"),
    url(r'^history/echoregister/$','echoregister', name="chronam_echoregister"),
    url(r'^history/heppnergazette/$','heppnergazette', name="chronam_heppnergazette"),
    url(r'^history/hillsboroargus/$','hillsboroargus', name="chronam_hillsboroargus"),
    url(r'^history/hoodriverglacier/$','hoodriverglacier', name="chronam_hoodriverglacier"),
    url(r'^history/hoodriversun/$','hoodriversun', name="chronam_hoodriversun"),
    url(r'^history/junctioncitybulletin/$','junctioncitybulletin', name="chronam_junctioncitybulletin"),
    url(r'^history/oregonrepublican/$','oregonrepublican', name="chronam_oregonrepublican"),
    url(r'^history/oregonunion/$','oregonunion', name="chronam_oregonunion"),
    url(r'^history/polkcountyobserver/$','polkcountyobserver', name="chronam_polkcountyobserver"),
    url(r'^history/roseburgreview/$','roseburgreview', name="chronam_roseburgreview"),
    url(r'^history/spraycourier/$','spraycourier', name="chronam_spraycourier"),
    url(r'^history/staterightsdemocrat/$','staterightsdemocrat', name="chronam_staterightsdemocrat"),
    url(r'^history/toveritar/$','toveritar', name="chronam_toveritar"),
    url(r'^history/uniongazette/$','uniongazette', name="chronam_uniongazette"),
    url(r'^history/beavertonowltimes/$','beavertonowltimes', name="chronam_beavertonowltimes"),
    url(r'^history/athenapress/$','athenapress', name="chronam_athenapress"),
    url(r'^history/auroraborealis/$','auroraborealis', name="chronam_auroraborealis"),
