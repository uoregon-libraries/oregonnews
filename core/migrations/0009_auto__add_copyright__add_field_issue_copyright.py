...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_copyright', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('core', ['Copyright'])

        # Adding field 'Issue.copyright'
        db.add_column('core_issue', 'copyright',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='issues', null=True, to=orm['core.Copyright']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Copyright'
        db.delete_table('core_copyright')

        # Deleting field 'Issue.copyright'
        db.delete_column('core_issue', 'copyright_id')
    ...
    models = {
        ...
        'core.issue': {
            ...
            'copyright': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'issues'", 'null': 'True', 'to': "orm['core.Copyright']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
